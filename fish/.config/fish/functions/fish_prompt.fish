function fish_prompt --description 'Write out the prompt'
	...
	echo -n -s (set_color $fish_color_user) "$USER" $normal @ (set_color $fish_color_host) "$__fish_prompt_hostname" $normal ' ' (set_color $color_cwd) (prompt_pwd) $normal (__fish_git_prompt) (virtual_env) $normal $prompt_status "$mode_str" "> "
end
