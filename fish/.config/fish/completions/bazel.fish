...
complete -f -n '__bazel_needs_command' -c bazel -a coverage -d 'Runs tests and collects coverage'
...
complete -f -n '__bazel_using_command coverage' -c bazel -a '(__bazel_targets ".*_bin|_.*test|.*binary")'
